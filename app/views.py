...
def load(request):
    # 🧀🥞🥪🌮🥗
    new = Recipe.objects.create(name='Pizza',
                                description='Italian-styled home-made dough recipe along with instructions on how to turn it into pizza 🍕',
                                prep='0:30:00', cook='1:30:00', servings=2, image='media/image_lHvewhO.jpg',
                                ingredients='Sample list of ingredients',
                                directions='''## Step 1 
something here
## Step 2 
something else here
...
last step''', notes='', author=request.user)
    ...
    new1 = Recipe.objects.create(name='Cheese', description='Some sample cheese recipe 🧀',
                                 prep='0:45:00', cook='2:00:00', servings=5, image='media/square.jpg',
                                 ingredients='Sample list of ingredients',
                                 directions='''## Step 1 
something here
## Step 2 
...
last step''', notes='', author=request.user)
    ...
    new2 = Recipe.objects.create(name='Pancake', description='Pancakes Yay 🥞',
                                 prep='0:10:00', cook='0:30:00', servings=5, image='media/download_4.jpeg',
                                 ingredients='Sample list of ingredients',
                                 directions='''## Step 1 
something here
## Step 2 
...
last step''', notes='', author=request.user)
    ...
    new3 = Recipe.objects.create(name='Sandwich', description='Sandwich to eat while you\'re bored during quarantine 🥪',
                                 prep='0:05:00', cook='0:10:00', servings=5, image='media/download_5.jpeg',
                                 ingredients='Sample list of ingredients',
                                 directions='''## Step 1 
something here
## Step 2 
...
last step''', notes='', author=request.user)
    ...
    new4 = Recipe.objects.create(name='Salad', description='Healthy salad coming your way 🥗',
                                 prep='0:15:00', cook='0:20:00', servings=5, image='media/salad_Mz61H85.jpg',
                                 ingredients='Sample list of ingredients',
                                 directions='''## Step 1 
something here
## Step 2 
